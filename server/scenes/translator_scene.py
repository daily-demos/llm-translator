...
class TranslatorScene(Scene):
    ...
    def prepare(self):
        ...
        print(
            f"👩‍💼 TranslatorScene prepare complete for: {self.sentence} in {self.message['translation_language']}")

    def perform(self):
        print(
            f"👩‍💼 TranslatorScene perform sentence: {self.sentence} in {self.message['translation_language']}")
